...
lib.ssMetadata = [
		{name:"VerTouch_atlas_1", frames: [[1596,0,375,321],[1596,323,375,321],[1596,646,375,321],[0,739,375,321],[377,739,375,321],[754,739,375,321],[1131,739,375,321],[1508,969,375,321],[0,1062,375,321],[377,1062,375,321],[754,1062,375,321],[1131,1062,375,321],[1508,1292,375,321],[0,1385,375,321],[377,1385,375,321],[754,1385,375,321],[1131,1385,375,321],[1508,1615,375,321],[0,1708,375,321],[377,1708,375,321],[754,1708,375,321],[1131,1708,375,321],[0,0,796,737],[798,0,796,737]]},
		{name:"VerTouch_atlas_2", frames: [[1508,0,383,239],[1508,241,383,239],[0,323,383,239],[385,323,383,239],[770,323,383,239],[1155,482,383,239],[1540,482,383,239],[0,564,383,239],[385,564,383,239],[770,564,383,239],[1155,723,383,239],[1540,723,383,239],[0,805,383,239],[385,805,383,239],[770,805,383,239],[1155,964,383,239],[1540,964,383,239],[0,1046,383,239],[385,1046,383,239],[385,1287,741,85],[1155,323,79,122],[0,0,375,321],[377,0,375,321],[770,1046,383,239],[1155,1205,383,239],[754,0,375,321],[1131,0,375,321],[1540,1205,383,239],[0,1287,383,239],[385,1374,270,186]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// x
	this.btnX = new cjs.Text("x", "normal 700 65px 'Assistant'", "#FFFFFF");
	this.btnX.name = "btnX";
	this.btnX.textAlign = "center";
	this.btnX.lineHeight = 86;
	this.btnX.lineWidth = 81;
	this.btnX.parent = this;
	this.btnX.setTransform(-39.3,85.45);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
	...
	this.instance.setTransform(-34,399,0.5873,0.7328);

	this.instance_1 = new lib.Bitmap75();
	this.instance_1.setTransform(-76,450,1.213,1.2291);

	this.instance_2 = new lib.altiso();
	this.instance_2.setTransform(701.05,139,1,1,0,0,0,94.6,55.1);
	...
	this.text.parent = this;
	this.text.setTransform(358.35,105.75);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text);
	}

	this.text_1 = new cjs.Text("דרגת חוזק 9\nתערובת אספרסו עוצמתית, עם מרקמם קטיפתי ועשיר\nוגוף מלא מצוינת לאספרסו או כבסיס למשקאות קפה .עם חלב", "normal 700 39px 'Assistant'", "#FFFFFF");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 822;
	this.text_1.parent = this;
	this.text_1.setTransform(381.95,195.7);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("EBGvgAHIAAAPMiNdAAAIAAgP");
	this.shape.setTransform(370.775,573.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("EhGuAmUMAAAhMnMCNdAAAMAAABMng");
	this.shape_1.setTransform(370.775,327.125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text_1},{t:this.text},{t:this.instance_2},{t:this.instance_1},{t:this.instance},{t:this.btnX}]}).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).to({state:[{t:this.btnX}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.btnX).wait(1).to({y:83.9},0).wait(1).to({x:-16.2,y:165.8},0).wait(1).to({x:3.5,y:103.3},0).wait(1).to({x:18.6,y:95.45},0).wait(1).to({x:33.7,y:101.45},0).wait(1).to({x:48.8,y:102.1},0).wait(1).to({x:57.7,y:98.2},0).wait(1).to({x:71.25,y:101.2},0).wait(1).to({x:87.25,y:107.4},0).wait(1).to({x:102.35,y:132.75},0).wait(1).to({x:72.1,y:105.3},0).wait(1).to({x:87.2,y:199.2},0).wait(1).to({x:102.3,y:112.05},0).wait(1).to({x:-24.8,y:109.4},0).wait(1).to({x:40.3,y:101.8},0).wait(1).to({x:42.6,y:142.65},0).wait(1).to({x:6.9,y:112.5},0).wait(1).to({x:37,y:108.85},0).wait(1).to({x:52.1,y:91.9},0).wait(1).to({x:67.2,y:100.8},0).wait(1).to({x:82.3,y:109.55},0).wait(1).to({x:47.3,y:16.45},0).wait(1).to({x:62.4,y:106.35},0).wait(1).to({x:77.5},0).wait(1).to({x:92.6},0).wait(1).to({x:107.5,y:91.9},0).wait(1).to({x:77.6,y:101.8},0).wait(1).to({x:75.7,y:91.9},0).wait(1));

	// tab
	this.instance_3 = new lib.Bitmap76();
	this.instance_3.setTransform(-33,399,0.5873,0.7328);

	this.instance_4 = new lib.Bitmap75();
	this.instance_4.setTransform(-75,450,1.213,1.2291);

	this.instance_5 = new lib.Untitled7();
	this.instance_5.setTransform(249,478,0.0763,0.0749);

	this.instance_6 = new lib.Untitled7();
	this.instance_6.setTransform(183,482,0.0582,0.0662);

	this.instance_7 = new lib.Untitled6();
	this.instance_7.setTransform(101,492,0.0661,0.0526);

	this.text_2 = new cjs.Text("דיאווליטו", "normal 700 60px 'Assistant'", "#FFFFFF");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 80;
	this.text_2.lineWidth = 265;
	this.text_2.parent = this;
	this.text_2.setTransform(358.35,104.2);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_2);
	}

	this.instance_8 = new lib.diavolito();
	this.instance_8.setTransform(679.95,137,1,1,0,0,0,94.6,55.1);

	this.text_3 = new cjs.Text(".תערובת הקפה העוצמתית ביותר שלנו, בדרגת חוזק 11\n,מושלמת להכנת אספרסו קצר וחזק \n.או ליצירת משקאות חלב עשירים במיוחד", "normal 700 39px 'Assistant'", "#FFFFFF");
	this.text_3.textAlign = "center";
	this.text_3.lineHeight = 53;
	this.text_3.lineWidth = 822;
	this.text_3.parent = this;
	this.text_3.setTransform(381.95,211.7);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(1,1,1).p("EhGugmTMCNdAAAMAAABMnMiNdAAAg");
	this.shape_2.setTransform(370.775,327.125);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("EhGuAmUMAAAhMnMCNdAAAMAAABMng");
	this.shape_3.setTransform(370.775,327.125);

	this.instance_9 = new lib.altiso();
	this.instance_9.setTransform(701.05,137.45,1,1,0,0,0,94.6,55.1);

	this.instance_10 = new lib.volteso();
	this.instance_10.setTransform(692.7,146.05,1,1,0,0,0,96.6,55.1);

	this.instance_11 = new lib.natol40();
	this.instance_11.setTransform(692.55,145.45,1,1,0,0,0,94.6,55.1);

	this.instance_12 = new lib.chiaro();
	this.instance_12.setTransform(703.95,159.6,0.4277,0.3344,0,0,0,191.6,119.6);

	this.instance_13 = new lib.scoro();
	this.instance_13.setTransform(678.85,152.5,0.5616,0.3976,0,0,0,191.5,119.6);

	this.instance_14 = new lib.leggero();
	this.instance_14.setTransform(673.35,146.2,0.6135,0.4694,0,0,0,191.7,120);

	this.instance_15 = new lib.arondio();
	this.instance_15.setTransform(679.15,150.75,0.5655,0.4017,0,0,0,191.6,119.5);

	this.instance_16 = new lib.fortado();
	this.instance_16.setTransform(693.2,142.2,0.4948,0.4377,0,0,0,191.6,119.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FFFFFF").ss(1,1,1).p("EhGugmTMCNUAAAIAJAAMAAABMnIgJAAMiNUAAA");
	this.shape_4.setTransform(363.675,335.125);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("EhGlAmUIgJAAMAAAhMnIAJAAMCNUAAAMAAABMng");
	this.shape_5.setTransform(362.775,335.125);

	this.instance_17 = new lib.costa();
	this.instance_17.setTransform(675.8,165.4,1.7194,1.4665,0,0,0,64.5,51.5);

	this.instance_18 = new lib.etyopiya();
	this.instance_18.setTransform(670,170.25,1.6698,1.5598,0,0,0,64.5,51.5);

	this.instance_19 = new lib.decaff150();
	this.instance_19.setTransform(669.45,148.05,0.562,0.4864,0,0,0,191.7,119.5);

	this.instance_20 = new lib.decaff230();
	this.instance_20.setTransform(663.75,160.3,0.6178,0.5891,0,0,0,191.8,119.5);

	this.instance_21 = new lib.mexico();
	this.instance_21.setTransform(669.85,186.45,1.7846,1.4598,0,0,0,66,38.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#FFFFFF").ss(1,1,1).p("EhGugrYMCNdAAAMAAABWxMiNdAAAg");
	this.shape_6.setTransform(362.775,367.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("EhGuArZMAAAhWxMCNdAAAMAAABWxg");
	this.shape_7.setTransform(362.775,367.6);

	this.instance_22 = new lib.colombia();
	this.instance_22.setTransform(681.35,163.25,2.0349,1.9151,0,0,0,65.8,38.3);

	this.instance_23 = new lib.vanik();
	this.instance_23.setTransform(646.35,184.9,0.7331,0.5923,0,0,0,187.7,160.4);

	this.instance_24 = new lib.carael();
	this.instance_24.setTransform(642.45,154.9,0.7197,0.6729,0,0,0,187.5,160.5);

	this.instance_25 = new lib.nets();
	this.instance_25.setTransform(694.1,155.4,0.4827,0.4084,0,0,0,187.6,160.4);

	this.instance_26 = new lib.forte();
	this.instance_26.setTransform(688.1,156.65,0.4561,0.4476,0,0,0,191.5,119.5);

	this.instance_27 = new lib.intenso();
	this.instance_27.setTransform(692.15,146.05,0.4517,0.4526,0,0,0,191.6,119.5);

	this.instance_28 = new lib.stormio();
	this.instance_28.setTransform(690.55,153.9,0.5039,0.4477,0,0,0,191.6,119.5);

	this.instance_29 = new lib.aodiso();
	this.instance_29.setTransform(676.05,63.1,0.5007,0.45,0,0,0,191.6,119.7);

	this.instance_30 = new lib.melozio();
	this.instance_30.setTransform(691.65,153.9,0.4986,0.4897,0,0,0,191.7,119.5);

	this.instance_31 = new lib.elvizo();
	this.instance_31.setTransform(673.6,146.65,0.5091,0.4477,0,0,0,191.5,119.5);

	this.instance_32 = new lib.jorjono();
	this.instance_32.setTransform(699.1,159,0.459,0.4146,0,0,0,191.5,119.5);

	this.instance_33 = new lib.sollu();
	this.instance_33.setTransform(692.5,161.35,0.4935,0.431,0,0,0,191.5,119.5);

	this.instance_34 = new lib.alto1();
	this.instance_34.setTransform(683.2,149.95,0.5038,0.5025,0,0,0,191.6,119.5);

	this.instance_35 = new lib.altu2();
	this.instance_35.setTransform(700.1,161.1,1,1,0,0,0,100.2,61.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3,p:{x:370.775,y:327.125}},{t:this.shape_2,p:{x:370.775,y:327.125}},{t:this.text_3,p:{y:211.7,text:".תערובת הקפה העוצמתית ביותר שלנו, בדרגת חוזק 11\n,מושלמת להכנת אספרסו קצר וחזק \n.או ליצירת משקאות חלב עשירים במיוחד",x:381.95,lineWidth:822}},{t:this.instance_8},{t:this.text_2,p:{text:"דיאווליטו",x:358.35,y:104.2,lineWidth:265}},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4,p:{x:-75,y:450}},{t:this.instance_3,p:{x:-33,y:399}}]},1).to({state:[{t:this.shape_3,p:{x:370.775,y:327.125}},{t:this.shape_2,p:{x:370.775,y:327.125}},{t:this.text_3,p:{y:194.15,text:"דרגת חוזק 9\nתערובת אספרסו עוצמתית, עם מרקמם קטיפתי ועשיר\nוגוף מלא מצוינת לאספרסו או כבסיס למשקאות קפה .עם חלב",x:381.95,lineWidth:822}},{t:this.text_2,p:{text:"אלטסיו",x:358.35,y:104.2,lineWidth:265}},{t:this.instance_9},{t:this.instance_4,p:{x:-76,y:449}},{t:this.instance_3,p:{x:-34,y:398}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 4\n,תערובת קפה אספרסו קלילה ומתקתקה, ארומות עשירות של בסיקווט ודגנים\n.חמיצות מאוזנת, גוף קליל ומרירות נמוכה\n.מצוינת לקפה עדין בשילוב עם חלב",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"וולטסו",x:350.35,y:112.2,lineWidth:265}},{t:this.instance_10},{t:this.instance_4,p:{x:-84,y:474}},{t:this.instance_3,p:{x:-42,y:423}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 7\n.תערובת קפה עוצמתית, אך נטולת קפאין\n.ארומות של קקאו ופרותיות עדינה",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"נטול קפאין חזק",x:352.05,y:112.2,lineWidth:405}},{t:this.instance_11},{t:this.instance_4,p:{x:-84,y:472}},{t:this.instance_3,p:{x:-42,y:421}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 6\nמצויינת להכנת מנה\n.כפולה של אספרסו מאוזן ",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"אספרסו כפול קיארו",x:338.15,y:112.2,lineWidth:477}},{t:this.instance_12},{t:this.instance_4,p:{x:-87,y:468}},{t:this.instance_3,p:{x:164,y:423}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:334.225}},{t:this.shape_2,p:{x:362.775,y:334.225}},{t:this.text_3,p:{y:201.25,text:"דרגת חוזק 8\n.מצוינת להכנת מנה כפולה של אספרסו כהה ועוצמתי\n.מרירות גבוהה וארומות המזכירות דגנים",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"אספרסו כפול סקורו",x:352.7,y:111.3,lineWidth:454}},{t:this.instance_13},{t:this.instance_4,p:{x:-86,y:467}},{t:this.instance_3,p:{x:165,y:422}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.225}},{t:this.shape_2,p:{x:362.775,y:335.225}},{t:this.text_3,p:{y:202.25,text:"תערובת קפה אספרסו כפול, שנוצרה במיחוד\nלשילוב עם חלב. שילוב פולי הקפה מאינדונזיה \nוקניה, שנקלו בקלייה בהירה – יוצרת ספל קפה\n.מתקתק ומאוזן",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"ביאנקו לגרו",x:328.05,y:112.3,lineWidth:310}},{t:this.instance_14},{t:this.instance_4,p:{x:-87,y:468}},{t:this.instance_3,p:{x:164,y:423}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 6\n.תערובת קפה מאוזנת, מצוינת להכנת ספל קפה גדול\nניתן להוסיף חלב או רק מעט, וכמובן ליהנות מהקפה .כמו שהוא",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"ארונדיו",x:350.35,y:112.2,lineWidth:265}},{t:this.instance_15},{t:this.instance_4,p:{x:-88,y:465}},{t:this.instance_3,p:{x:368,y:420}}]},1).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 8\n.תערובת קפה עוצמתית, מצוינת להכנת ספל קפה גדול\nניתן להוסיף כמות גדולה של חלב או רק מעט, וכמובן גם להנות מהקפה כמו שהוא",x:374.85,lineWidth:822}},{t:this.text_2,p:{text:"פורטדו",x:351.25,y:112.2,lineWidth:265}},{t:this.instance_16},{t:this.instance_4,p:{x:-86,y:462}},{t:this.instance_3,p:{x:370,y:417}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:364.575}},{t:this.shape_2,p:{x:362.775,y:364.575}},{t:this.text_3,p:{y:231.6,text:"תערובת קפה נדירה בדרגת חוזק 7 , עם מתיקות\nעדינה וארומות עשירות, בזכות פולי הערביקה\nשנשטפו במי מעיינות חמים. מתאימה למי שאוהב\n.קפה גדול עם חלב, ומחפש פולים נדירים",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"קוסטה ריקה",x:360.8,y:141.5,lineWidth:323}},{t:this.instance_17},{t:this.instance_4,p:{x:-87,y:502}},{t:this.instance_3,p:{x:370,y:457}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:234.4,text:"תערובת קפה בדרגת חוזק 4 , עדינה במיוחד ועם\n.טעם אופייני לקפה אתיופי – חמצמץ ומתקתק\nמתאימה למי שאוהב קפה ערביקה בלבד, בכוס\n.גדולה עם או בלי חלב",x:365.1,lineWidth:903}},{t:this.text_2,p:{text:"אתיופיה",x:347.55,y:150.85,lineWidth:265}},{t:this.instance_18},{t:this.instance_4,p:{x:-90,y:469}},{t:this.instance_3,p:{x:367,y:424}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:339.125}},{t:this.shape_2,p:{x:362.775,y:339.125}},{t:this.text_3,p:{y:206.15,text:"דרגת חוזק 4\nתערובת הקפה נטול אונטנסו מתאפיינת בארומות\nדגניות, גוף קליל וחמיצות עדינה ומרקם קטיפתי\n.במיוחד\n",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"נטול קפאין אונטנסו",x:339.1,y:116.05,lineWidth:465}},{t:this.instance_19},{t:this.instance_4,p:{x:-86,y:458}},{t:this.instance_3,p:{x:372,y:413}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:344.725}},{t:this.shape_2,p:{x:362.775,y:344.725}},{t:this.text_3,p:{y:211.75,text:"דרגת חוזק 6\nתערובת הקפה נטול קפאין מתאפיינית בארומות\nמודגשות של דגנים, מרירות מאוזנת וגוף עשיר\n.המקנה תחושה עגולה בחלל הפה",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"נטול קפאין",x:350.35,y:121.8,lineWidth:265}},{t:this.instance_20},{t:this.instance_4,p:{x:-84,y:468}},{t:this.instance_3,p:{x:553,y:423}}]},1).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.text_3,p:{y:234.6,text:"קפה עוצמתי ונדיר בדרגת חוזק 7 עם ארומות\nמורגשות של קלייה ומרירות מאוזנת, בזכות פולי\n.הקפה מסוג רובוסטה שעובדו בשטיפה כפולה\n,מתאימה למי שמחפש כוס קפה גדולה ועוצמתית\n.גם עם חלב",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"מקסיקו",x:350.35,y:144.65,lineWidth:265}},{t:this.instance_21},{t:this.instance_4,p:{x:-86,y:536}},{t:this.instance_3,p:{x:552,y:491}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 5\nמאוזנת במיוחד ועם טעם פירותי עשיר ומעט\nמתקתק, הנוצר בזכות שימוש בפולי\n.ערביקה בלבד",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"קולומביה",x:350.35,y:112.2,lineWidth:265}},{t:this.instance_22},{t:this.instance_4,p:{x:-86,y:471}},{t:this.instance_3,p:{x:553,y:438}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:370.125}},{t:this.shape_2,p:{x:362.775,y:370.125}},{t:this.text_3,p:{y:258.65,text:"תערובת קפה בטעם וניל פאי, מאוזנת במיוחד ועם\nארומות וטעמים עשירים. מומלץ במיוחד לשתות\nאת הקפה עם חלב ואפילו להוסיף קוביות קרח כדי\n.לקבל תחושה של גלידה טעימה",x:370.6,lineWidth:822}},{t:this.text_2,p:{text:"פאי וניל",x:341.55,y:174.15,lineWidth:265}},{t:this.instance_23},{t:this.instance_4,p:{x:-86,y:506}},{t:this.instance_3,p:{x:553,y:473}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:239.6,text:"תערובת קפה בטעם מאפין עוגיות קרמל, מאוזנת\nבמיוחד ועם ארומות וטעמים עשירים. מומלץ\nבמיוחד לשתות את הקפה עם חלב ולהתפנק\n.בבוקר מתקתק וחייכני",x:364.35,lineWidth:822}},{t:this.text_2,p:{text:"עוגיות קרמל",x:310.45,y:137.15,lineWidth:326}},{t:this.instance_24},{t:this.instance_4,p:{x:-86,y:471}},{t:this.instance_3,p:{x:553,y:438}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:343.075}},{t:this.shape_2,p:{x:362.775,y:343.075}},{t:this.text_3,p:{y:210.1,text:"שילוב נפלא בין טעם אגוזי לוז לטעם עדין של\nשקדים וביסקוויט. טעם אגוזי הלוז משתלב נפלא\nעם פולי קפה הערביקה, ונוצר טעם עדין של\n.מאפים",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"מאפין אגוזי לוז",x:364.6,y:120.15,lineWidth:419}},{t:this.instance_25},{t:this.instance_4,p:{x:-86,y:478}},{t:this.instance_3,p:{x:554,y:445}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:237.6,text:"תערובת קפה להכנת ספל קפה גדול ועוצמתי עם\nחלב. פולי הקפה מקניה וקולומביה \"פורצים\" דרך\n.תוספת החלב, ושומרים על טעם וארומות הקפה",x:362.4,lineWidth:822}},{t:this.text_2,p:{text:"ביאנקו פורטה",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_26},{t:this.instance_4,p:{x:-87,y:455}},{t:this.instance_3,p:{x:554,y:422}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 9\nתערובת הקפה החזקה ביותר שלנו לכוס גדולה\nקפה עוצמתי עם מרירות מורגשת\n.וארומות נפלאות של קלייה",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"אינטנסו",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_27},{t:this.instance_4,p:{x:-87,y:467}},{t:this.instance_3,p:{x:554,y:434}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 8\nתערובת הקפה סטורמיו מתאפיינית בארומות\nעשירות של קלייה ושל דגנים, גוף מלא ומרירות\n להכנת כוס קפה גדולה עם או בלי חלב ,גבוהה.",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"סטורמיו",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_28},{t:this.instance_4,p:{x:-87,y:474}},{t:this.instance_3,p:{x:550,y:432}}]},1).to({state:[{t:this.shape_3,p:{x:347.675,y:245.225}},{t:this.shape_2,p:{x:347.675,y:245.225}},{t:this.text_3,p:{y:112.25,text:"בדרגת חוזק 7\nתערובת קפה עוצמתית, המתאימה\nלספל קפה גדול עם או בלי חלב. לתערובת \nטוויסט פירותי שמוסיף טעם וארומות לספל הקפה.",x:358.85,lineWidth:822}},{t:this.text_2,p:{text:"אודסיו",x:349.5,y:22.3,lineWidth:419}},{t:this.instance_29},{t:this.instance_4,p:{x:-102,y:382}},{t:this.instance_3,p:{x:535,y:340}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"בדרגת חוזק 6\n.תערובת קפה מאוזנת במיוחד\nמושלמת להכנת ספל קפה גדול שאינו עוצמתי\n.מדי ומשתלב נפלא עם חלב",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"מלוזיו",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_30},{t:this.instance_4,p:{x:-87,y:467}},{t:this.instance_3,p:{x:550,y:425}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 4\nתערובת קפה קלילה, המתאימה להכנת כוס קפה\nגדולה. טעם וארומות עדינים מתקתקים\n.חמצמצים",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"אלווציו",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_31},{t:this.instance_4,p:{x:-88,y:472}},{t:this.instance_3,p:{x:549,y:430}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:"דרגת חוזק 4\nתערובת קפה עדינה, המיועדת\nלהכנת ספל קפה גדול עם ארומות עדינות\n.המזכירות פרחים רעננים",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"ג'יורניו",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_32},{t:this.instance_4,p:{x:-86,y:472}},{t:this.instance_3,p:{x:551,y:430}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:343.775}},{t:this.shape_2,p:{x:362.775,y:343.775}},{t:this.text_3,p:{y:210.8,text:"בדרגת חוזק 2\nתערובת הקפה העדינה ביותר שלנו המיועדת\nלכוס גדולה. מצויינת למי שואהב\n.קפה עדין במיוחד עם חלב",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"סולליו",x:364.6,y:120.85,lineWidth:419}},{t:this.instance_33},{t:this.instance_4,p:{x:-87,y:478}},{t:this.instance_3,p:{x:551,y:436}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:335.125}},{t:this.shape_2,p:{x:362.775,y:335.125}},{t:this.text_3,p:{y:202.15,text:" דרגת חוזק 7\nתערובת קפה, מושלמת למי\nשמחפש ליהנות מספל קפה ענקי ומפנק, עם או\n.בלי תוספת חלב",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"אלטו איטנסו",x:364.6,y:112.2,lineWidth:419}},{t:this.instance_34},{t:this.instance_4,p:{x:-90,y:465}},{t:this.instance_3,p:{x:727,y:423}}]},1).to({state:[{t:this.shape_3,p:{x:362.775,y:339.325}},{t:this.shape_2,p:{x:362.775,y:339.325}},{t:this.text_3,p:{y:206.35,text:"דרגת חוזק 4\nתערובת קפה, מושלמת למי\n,שמחפש ליהנות מספל קפה מאוזן גדול במיוחד\n.עם או בלי תוספת חלב",x:373.95,lineWidth:822}},{t:this.text_2,p:{text:"אלטו דולצ'ה",x:364.6,y:116.4,lineWidth:419}},{t:this.instance_35},{t:this.instance_4,p:{x:-86,y:472}},{t:this.instance_3,p:{x:728,y:430}}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-106,-1,930.5,647.3);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function clickMO2(){
			...
			self.tabs.visible = true; //פותח כרטסית מידע 
			self.tabs.gotoAndStop(14); //פותח את הכרטסיה בפריים הנכון
		}
	...
	this.instance.setTransform(826.3,411.2,0.9957,1.1147,0,0,0,828.6,367.8);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/VerTouch_atlas_1.png?1619345962474", id:"VerTouch_atlas_1"},
		{src:"images/VerTouch_atlas_2.png?1619345962474", id:"VerTouch_atlas_2"}
	],
	preloads: []
};
